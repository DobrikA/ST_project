...
#if defined (STM32F427_437xx) || defined (STM32F429_439xx)
	#define PLL_N      336	/// 168 MHz
	///#define PLL_N      240	/// 120 MHz
	/* SYSCLK = PLL_VCO / PLL_P */
	#define PLL_P      2
	/* USB OTG FS, SDIO and RNG Clock =  PLL_VCO / PLLQ */
	#define PLL_Q      7	/// 168 MHz
	///#define PLL_Q      5	/// 120 MHz
#endif /* STM32F427_437x || STM32F429_439xx */
...
/******************************************************************************/
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /* HCLK = SYSCLK / 1*/
    RCC->CFGR |= RCC_CFGR_HPRE_DIV1;	/* AHB Devider (max frequency = 180 MHz) */

#if defined (STM32F40_41xxx) || defined (STM32F427_437xx) || defined (STM32F429_439xx)
    /* PCLK2 = HCLK / 2*/
    RCC->CFGR |= RCC_CFGR_PPRE2_DIV2;	/* APB2 Devider (max frequency = 90 MHz) */
    
    /* PCLK1 = HCLK / 4*/
    RCC->CFGR |= RCC_CFGR_PPRE1_DIV4;	/* APB1 Devider (max frequency = 45 MHz) */
#endif /* STM32F40_41xxx || STM32F427_437x || STM32F429_439xx */
